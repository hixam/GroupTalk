...
public interface GroupDAOQuery {
    ...
    public final static String GET_GROUP_BY_ID = "select hex(g.id) as id, g.nombre, r.userid from groups g, relacionUserGrupo r where g.id=unhex(?) and r.groupid=g.id ";
